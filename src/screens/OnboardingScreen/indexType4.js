...
import { AppPadding, AppShadow, AppWidth } from '../../constants/commonStyle';
			...
			<View style={{
				...
				<View style={{ marginBottom: 50, alignItems: 'center' }}>
					{currentSlideIndex == data.length - 1 ? (
						<View style={{ padding: AppPadding._15 }}>
							<AppText onTextPress={() => navigation.replace('LoginScreen')} fontFamily={Fonts.BOLD} label={`Explore!`} />
						</View>
					) : (
						<TouchableOpacity
